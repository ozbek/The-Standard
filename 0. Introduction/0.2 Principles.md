...
The Standard shall be taught man to man, not machine to man. No stylecops or analyzers should be implemented as the primary mechanism to force compliance. It must be driven by passion in the heart and conviction in the mind, not coercion. The Standard is best carried through person-to-person teaching, fostering an engineering culture of open discussion, shared understanding, and deeply held conviction.

AI-assisted coding (including “vibe coding”) is welcome, provided a human remains actively engaged in the process and retains full responsibility for the final code produced. AI may serve as a tool for acceleration, exploration, and even code review, but it must never replace human judgment.

The final authority for approval, acceptance, and merge decisions must always rest with a human.
